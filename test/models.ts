...
// @ts-nocheck
export class OutputUsesInternal {
    constructor(base, user, unusedUserAction) {
        this.base = base;
        this.internal = {};
        var internal = this.internal;
        internal.dim_a = 3;
        internal.initial_x = 1;
        internal.a = new Array(internal.dim_a);
        this.setUser(user, unusedUserAction);
    }
    ...
    rhs(t, state, dstatedt) {
        var internal = this.internal;
        const x = state[0];
        for (var i = 1; i <= internal.dim_a; ++i) {
            internal.a[i - 1] = x;
        }
        dstatedt[0] = internal.a[0] + internal.a[1] + internal.a[2];
    }
    ...
    output(t, state) {
        ...
        output[0] = internal.a[0] + internal.a[1] + internal.a[2];
        return output;
    }
    ...
    updateMetadata() {
        ...
        this.metadata.ynames.push("x");
        this.metadata.ynames.push("y");
        this.metadata.internalOrder = {a: internal.dim_a, dim_a: null, initial_x: null};
        this.metadata.variableOrder = {x: null};
        this.metadata.outputOrder = {y: null};
    }
